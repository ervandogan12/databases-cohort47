...
export const AUTHOR_PULISHED_TITLE =
  "SELECT au.*, rp.paper_title FROM library.authors au LEFT JOIN library.author_paper ap ON au.author_id= ap.author_id JOIN library.research_papers rp ON ap.paper_id = rp.paper_id;";
